...
function New-SyntheticRepo {
    ...
    foreach ($name in @('focus-runtime.ps1', 'cc_focus.py', 'cycle_prompts.py', 'cycle_state.py', 'cycle_transport.py', 'cycle_workflow.py', 'focus_control.py', 'focus_progress.py', 'focus_output.py', 'focus_messages.py', 'focus_input.py', 'focus_terminal.py', 'focus_status.py', 'focus_project.py', 'focus_publication.py', 'focus_reconcile.py', 'focus_commit.py', 'focus_publication_recovery.py')) {
