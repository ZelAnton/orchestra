...
Invoke-Test -Name 'cc-resume.cmd' -Body {
    ...
    try {
        ...
        $flags = @('--agent', 'processor', '--allowedTools', 'Bash(codex exec:*)', 'Bash(pwsh -File tools/codex-runtime.ps1:*)', 'Bash(pwsh -File tools/jcode-runtime.ps1:*)', 'Bash(pwsh -File ~/.claude/scripts/jcode-runtime.ps1:*)', '--permission-mode', $expectedMode, '--continue')
    ...
    try {
        ...
        $captured = Get-CapturedArgs $captureFile
        $flags = @('--agent', 'processor', '--allowedTools', 'Bash(codex exec:*)', 'Bash(pwsh -File tools/codex-runtime.ps1:*)', 'Bash(pwsh -File tools/jcode-runtime.ps1:*)', 'Bash(pwsh -File ~/.claude/scripts/jcode-runtime.ps1:*)', '--permission-mode', $expectedMode)
