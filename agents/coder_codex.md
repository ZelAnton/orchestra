...
- `network` / `tls-schannel` — сетевой шаг за пределами возможностей песочницы. При
  **доступном брокере** (интеграционная точка **T-063**; сам брокер этой задачей не
  реализуется — здесь только ссылка на будущий шаг) передай сетевой шаг брокеру и
  **продолжай** (не эскалация). Брокер **недоступен/выключен** (сейчас — всегда, пока
  T-063 не внедрён) → **немедленная эскалация** с классом:
