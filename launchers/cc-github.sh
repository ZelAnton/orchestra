...
exec claude --agent github_sync --permission-mode auto "Per your system prompt, sync GitHub with the task queue: enqueue tasks from open issues/PRs and close the ones that are done. Start now."
