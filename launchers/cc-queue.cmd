...
rem      используем;
rem   3) двойные кавычки внутри ARGS заменяются на одинарные (общий шаг
rem      cc-common.cmd:sanitize, тот же, что и у cc-thinker.cmd) — иначе
rem      кавычка в аргументе разорвала бы кавычки промпта, и claude получил
rem      бы несколько несвязных позиционных аргументов вместо одного текста
rem      задания.
