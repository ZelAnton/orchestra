...
call "%~dp0cc-common.cmd" run github_sync acceptEdits "Per your system prompt, sync GitHub with the task queue: enqueue tasks from open issues/PRs and close the ones that are done. Start now."
