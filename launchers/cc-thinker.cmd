@echo off
chcp 65001 >nul
rem Launch the "thinker" analytical partner in the current folder (Claude Code, acceptEdits mode).
...
if "%~1"=="" (
  ...
  claude --agent thinker --permission-mode acceptEdits "Per your system prompt: act as the analytical thinking partner for this project. Opening topic: !ARGS!"
)
